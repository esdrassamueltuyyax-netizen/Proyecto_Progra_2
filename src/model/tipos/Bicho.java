...
public class Bicho extends Pokemon {
    ...
    public Bicho(int ataqueEspecial, int defensaEspecial, String elemento, String debilidad,String descripcion, String nombre, int numeroPokemon, int ps, int ataque, int defensa, int velocidad, String tipo, String altura, String categoria, String peso, String habilidad, String genero, String rutaImagen) {
